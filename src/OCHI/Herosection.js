  ...
  return (
    <div data-scroll data-scroll-speed="-.8" className=' min-h-screen bg-stone-100'>
      ...
      <div className='hero-wrapper h-[80vh] lg:h-[88vh] lg:px-12  lg:pl-7 pl-2 lg:text-[10vw] text-[9vh] font-big text-[#6e6e6f] flex flex-col justify-center uppercase lg:pt-8  lg:leading-[8vw] leading-[14vw] '>
        ...
        <div className='flex relative z-10 lg:my-0 my-2'><img className='lg:w-[11vw] lg:mt-3 lg:h-[7vw] lg:rounded-lg  h-[9vh]   absolute  rounded-lg ' src={heropic}></img><h1 className='odd text-nowrap bg-stone-900 lg:leading-[7rem] leading-[9vh]'>eye opening</h1></div>
        <h1>presentation</h1>
      </div>
